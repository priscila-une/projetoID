...
class Usuario(models.Model):
    ...
    numero_cadastro= models.IntegerField(max_length=20, null=True, blank=True)
    eol = models.IntegerField(max_length=20, null=True, blank=True)
    ...
    idade = models.PositiveSmallIntegerField(max_length=3, null=True, blank=True)
    ...
    numero_certidao = models.IntegerField(max_length=10, null=True, blank=True)
